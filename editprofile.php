        ...
        <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="bio" id="bio" rows="5" placeholder="Conte um pouco de você aos outros usuários!"><?= $userData->bio ?></textarea>
                        </div>
                    </div>
                </div>
            </form>
            <div class="row" id="change-password-container">
                <div class="col-md-4">
                    ...
                    <p class="page-description">Digite uma nova senha e confirme para alterar:</p>
